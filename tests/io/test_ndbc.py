...
FILES_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "../sample_files/ndbc")
...
class TestNDBC(object):
    ...
    def setup_class(self):
        ...
        self.ds_history_1d = read_ndbc(os.path.join(FILES_DIR, "41010w2019.txt.gz"))
        self.ds_history_2d = read_ndbc([
            os.path.join(FILES_DIR, "41010w2019.txt.gz"), #swden
            os.path.join(FILES_DIR, "41010d2019.txt.gz"), #swdir
            os.path.join(FILES_DIR, "41010i2019.txt.gz"), #swdir2
            os.path.join(FILES_DIR, "41010j2019.txt.gz"), #swr1
            os.path.join(FILES_DIR, "41010k2019.txt.gz") #swr2
        ])
