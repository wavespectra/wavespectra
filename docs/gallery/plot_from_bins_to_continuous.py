"""
Converting bin-defined spectra to continuous spectra
=====================================================

An algorithm to convert the spectral data from a bin-definition to a continuous curve is included.

Note: OchiHubble is just used to get some data
"""
